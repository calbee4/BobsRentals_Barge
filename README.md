...
#      Reduce Inventory(Class: class, intAmount: integer): Subtracts from the inventory of the provided Class (should be a subclass of Equipment) by intAmount. Any number < 0 is set to 0. Prints a message if the reduced amount would make the inventory drop below 0.
#
# Skis Class:
